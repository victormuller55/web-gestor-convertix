...
export function Pagination({
  ...
  return (
    <div className="flex flex-col gap-3 border-t border-line bg-card px-6 py-3 pb-[max(1rem,env(safe-area-inset-bottom))] text-sm text-muted md:flex-row md:flex-wrap md:items-center md:justify-between md:pb-4">
